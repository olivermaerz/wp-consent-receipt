    ...
    <div class="row">
      ...
      <div class="col-sm-5 bootcards-list" id="list" data-title="Contacts">
        ...
        <div class="col-sm-7 bootcards-cards hidden-xs">
          ...
          <div class="panel panel-default bootcards-richtext">
            ...
            <div class="panel-body">
              ...
              <ul>
                ...
                <li>Near-native iOS and Android look (there's one for Desktop too).</li>
          ...
          <div class="panel panel-default bootcards-richtext">
            <div class="panel-heading">
              <h3 class="panel-title">Theme Switcher</h3>
            </div>
            <div class="panel-body">
              ...
              <!--theme switcher-->
                <div class="btn-group" data-toggle="buttons">
                  <label class="btn btn-primary active">
                    <input type="radio" name="themeSwitcher" value="ios" autocomplete="off" checked> iOS
                  </label>
                  <label class="btn btn-primary">
                    <input type="radio" name="themeSwitcher" value="android" autocomplete="off"> Android
                  </label>
                  <label class="btn btn-primary">
                    <input type="radio" name="themeSwitcher" value="desktop" autocomplete="off"> Desktop
                  </label>
                </div>
            </div>
